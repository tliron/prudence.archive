 ...
 * @author Tal Liron
 */
public class PHP extends DistributionTest
{
	//
	// Construction
	//
	...
	private static Runnable[] prudenceTests = new Runnable[]
	{
		...
		// /web/dynamic/
		new TestOK( "/prudence-test/test/quercus/?id=hello" ), new TestOK( "/prudence-test/test/velocity/?id=hello" ),
		// /resources/
		new TestOK( "/prudence-test/data/quercus/" )
	};
}
