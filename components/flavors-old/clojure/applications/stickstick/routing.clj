...
(def css-filter (CssUnifyMinifyFilter. nil (File. (str application-base-path static-web-base-path)) minimum-time-between-validity-checks))
(def java-script-filter (JavaScriptUnifyMinifyFilter. nil (File. (str application-base-path static-web-base-path)) minimum-time-between-validity-checks))
