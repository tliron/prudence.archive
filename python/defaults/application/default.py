...
task_collector = PrudenceTaskCollector(File(application_base_path + '/crontab'), scheduler_document_source, language_manager, 'python', True, application_instance.context)
